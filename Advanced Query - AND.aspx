<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Advanced Query - AND.aspx.cs" Inherits="Advanced_Query___AND" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            and Select Book Type:<asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource3" DataTextField="type" DataValueField="type">
            </asp:DropDownList>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [Query1] WHERE (([pub_name] = ?) AND ([type] = ?))">
            <SelectParameters>
